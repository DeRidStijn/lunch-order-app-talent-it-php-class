...
class Brood
{
    ...
    function __construct(bool $smos, bool $fitness, int $typeBeleg, bool $baguette, int $aantalBroodjes, string $opmerking, string $supplement)
    {
        $this->smos = $smos;
